...
allocate(w(0:set_num_soln,set_line),w2(0:set_num_soln,set_line))
 ...
 open(20,file="aveERmod_PVA_conv/soln/weight_soln")
 do i=1,set_line
...
allocate(e_num(0:set_num_soln,set_line), e_num2(0:set_num_soln,set_line))
  ...
  print *, ave_e
  print *, ave_e2
  write(fname2,"('aveERmod_PVA_conv/soln/aveuv.tt')") 
  open(20,file=fname2)
  do i=1,set_line
...
allocate(e_num(0:set_num_soln,set_line), e_num2(0:set_num_soln,set_line))
 ...
 do k=1,5
  ...
  write(fname2,"('aveERmod_PVA_conv/soln/engsln.'i2.2)") k
  open(20,file=fname2)
  do i=1,set_line
...
allocate(w(0:set_num_refs,set_line),s(0:set_num_refs,set_line))
 ...
 open(20,file="aveERmod_PVA_conv/refs/weight_refs")
 do i=1,set_line
  ave_w(i) = sum_w(i)/dble(sample_num+1)
...
allocate(e_num(0:set_num_refs,set_line))
 ...
 do k=1,5
  ...
  write(fname2,"('aveERmod_PVA_conv/refs/engref.'i2.2)") k
  open(20,file=fname2)
  do i=1,set_line
   ave_e(i) = ave_e(i)/sum_w(k)
   write(20,660) line(i), ave_e(i)
...
allocate(cormat_temp(set_line,set_line),rdcor(set_line,set_line))
 ...
 do k=1,5
  ...
  write(fname2,"('aveERmod_PVA_conv/refs/corref.'i2.2)") k
