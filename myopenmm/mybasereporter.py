...
class _MyBaseReporter(object):
    ...
    def __init__(self, file, reportInterval, coordinates=True,
                 cell=True, time=True, potentialEnergy=True, kineticEnergy=True,
...
# End Modification
        if self._cell:
            ...
            vectors /= units.nanometer
            box = (vectors[0,0],90.0,vectors[1,1],90.0,90.0,vectors[2,2])
# Modified for XTC File Format
